  ...
  return (
    ...
    >
      <div className="flex flex-col items-start text-left text-white w-full px-40 py-20 ">
        ...
        <div
          className=" flex items-center h-96 w-full justify-start overflow-hidden rounded-2xl bg-gradient-to-r from-yellow to-pink mt-[1400px] "
          ...
          <div className="text-center ml-[50%]  text-white  w-[40%] ">
            <div className="w-full flex flex-col gap-4">
              ...
              <p className="text-xl font-normal text-left">
                Tem lugar pra vocês tambem! Nós envie uma mensagem e vamos bater
                um papo!
              </p>
            </div>
          </div>
